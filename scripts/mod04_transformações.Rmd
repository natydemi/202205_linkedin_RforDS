...
Juntando essas principais funções com o pipe – conforme comentado no módulo 1, conseguimos praticamente dividir em passos o que precisa ser feito com a base de dados, deixando os scripts mais legíveis e organizados.

Por exemplo, se você precisa descobrir **quais voos da companhia American Airlines tiveram o maior tempo de atraso**, é possível separar essa pergunta em diferentes etapas:
...
Como a base de dados `voos` já está no formato tidy, vamos trabalhar com outro dataset, no caso, o conjunto `billboard`, que lista os rankings de música na Billboard top 100 durante o ano 2000.
...
Como o inverso da função anterior, `pivot_wider()` transforma o conjunto de dados em um formato largo, ou seja, onde o número de colunas aumenta e o de linhas diminui.
