...
EDA, do inglês Exploratory Data Analysis, e em português Análise Exploratória de Dados, é o processo de explorar os dados, o que tipicamente inclui desde examinar a estrutura do dataset, algo que iniciamos no módulo anterior, até o entendimento mais profundo sobre o comportamento de uma variável, ou padrões entre variáveis. A EDA nos permite:
...
- Desenvolver uma esboço da resposta à sua pergunta, por vezes respondê-la de fato
