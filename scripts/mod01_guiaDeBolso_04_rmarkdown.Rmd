---
title: "Guia de Bolso - Intro arquivos Rmarkdown"
...
É importante saber que ao trabalhar com o Rmarkdown você está em um ambiente apartado do seu console. De modo que o que você rodar no console não estará valendo para o seu Rmarkdown.
...
> DICA: explorar a opção "Visual" do Rmarkdown (disponível em versões mais recentes), que nos permite trabalhar com uma interface com menos código, e mais opções point-and-click.



# MÃO NA MASSA!

Que tal repassar os scripts deste módulo para um Rmarkdown? Você pode fazer uma curadoria do que é importante para você, possibilitando um material para consulta melhor formatado, mais visual, e com os seus próprios comentários! :)
