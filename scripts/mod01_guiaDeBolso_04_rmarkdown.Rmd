...
# O Rmarkdown
Rmarkdown é script com formato (.Rmd) que nos possibilita trabalhar com códigos, assim como um script usual .R. Contudo aqui temos a possibilidade de adicionar textos e visualizar os outputs dos códigos, de maneira mais visual e interativa. Permitindo uma maior praticidade durante a análise. Além disso o Rmarkdown pode ser compilado, de modo que o produto final seja salvo como um arquivo HTML , PDFs, Word, slides, entre outros. 
