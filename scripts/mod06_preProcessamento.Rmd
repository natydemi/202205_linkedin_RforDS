...
Data wrangling ou limpeza de dados, é uma tarefa que costuma , mas sim algo que você precisa lidar durante todo o processo de análise -- sendo 
...
- O livro [Feature Engineering and Selection: A Practical Approach for Predictive Models](http://www.feat.engineering/) é uma das minhas referências preferidas, visto os excelentes cases e discussões que apresenta. Nos ajudando a desenvolver não apenas em termos técnicos, mas também com a intuição do que as ferramentas oferecem. A sugestão aqui é que você o consulte para evoluir nos conteúdos deste capítulo, particularmente: dados faltantes no capítulo 8 e encoding no capítulo 5.
