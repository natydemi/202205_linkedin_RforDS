...
Na wikipedia a definição de Feature Engineering, o que em português seria algo como Engenharia de Features é: "descoberta de variáveis, é o processo de usar o conhecimento da área de negócio, para extrair features (características, propriedades, atributos)". 




Evolução ~ cálculo de tendência, sazonalidade e calendário
- coef. angular, média móvel, dia da semana, 
