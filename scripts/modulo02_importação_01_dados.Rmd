...
### Alguns pacotes legais para encontrar bases de dados
...
Para explorar mais opções de dataset existentes em bibliotecas do R, este aplicavo Shiny é particularmente interessante: [Find R data that you need](https://marija-stanojcic.shinyapps.io/R_datasets/), algo como "encontre os dados do R que você precisa". Nele você pode pesquisar bases de dados a partir da especificação de informações como: número mínimo de observações desejadas, a presença de determinados tipo de variáveis, ou palavras-chave relacionadas. 


### Alguns sites legais para pesquisar bases de dados

Seguem algumas opções de sites em que você poderá procurar por bases de dados de diferentes temáticas e especialidades:
