...
Mas onde o arquivo `base_exportada.csv`, criado acima se encontra no seu computador? Onde o arquivo foi salvo? É a resposta é: no seu diretório de trabalho, basicamente a pasta do seu computador que está sendo entendida pelo R como a sua pasta raiz, a sua pasta de referência.  
...
Como alternativa as funções comentadas, você pode explorar a aba `File` do RStudio, onde encontrará algumas opções point-and-click para navegar e manusear pelos diretórios. 
