...
Assim, seja considerando em uma linha de exploração descritiva, por meio de volumetrias, estatísticas e visualizações, quanto utilizando uma abordagem mais diagnóstica, explorando comportamentos mais complexos, como padrões de associação, por exemplo. Em linhas gerais, é na etapa de exploração que **aprendemos** e damos **sentido** aos dados!
