...
- {data} - Dados que serão visualizados
- {aesthetic mappings} - Mapeamentos estéticos dos dados para componentes visuais
- Objetos geométricos que aparecem na plotagem
- As estatísticas transformam os dados no caminho para a visualização
- As coordenadas organizam a localização de objetos geométricos
- As escalas definem o intervalo de valores para a estética
- {facet} - As facetas agrupam-se em subtramas
