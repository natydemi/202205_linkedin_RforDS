...
# Módulo 02 - Revisão - Linguagem R e RStudio
...
# Tipos de Dados no R -----
    ...
    # para testar e converter objetos, respectivamente:
    ...
    #Tais definições são importantes pois algumas funções só farão sentido para determinadas classes
        #tentativa de cálculo com um objeto de texto 
        log(x)
        
    #Uma característica do armazenamento dos objetos no R, 
...
# Estruturas de Dados -----
    ...
    #como os objetos podem ser organizados em termos de estrutura?
        #Vetores atômicos
            #estrutura mais básica do R, se caracterizam por uma única dimensão, 
            # e guardam objetos de um mesmo tipo. 
        #Matrizes
            #nos permitem trabalhar com dados bidimensionais que contenham o 
            # mesmo tamanho e o mesmo tipo de dados
        #Arrays
            #similares as Matrizes, porém permitindo mais que duas dimensões 
        #Data Frame
            #estruturas bidimensionais mais genéricas que as matrizes, uma vez 
            # que suas colunas podem conter tipos de dados diferentes.
        #Listas
            #permitem que diferentes tipos de dados sejam guardados em um único 
            # `vetor` além de serem recursivos, i.e., uma lista pode conter 
            # outras listas, de diferentes tamanhos
...
#  ----- MÃO NA MASSA! -----
    ...
    #3. exporte os resultados em um csv, onde este csv foi salvo?
