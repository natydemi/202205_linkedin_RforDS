...
Rmarkdown é um formato (.Rmd) que nos possibilita trabalhar com códigos, assim como um script .R usual, mas também com os outputs dos códigos e textos, de forma mais interativa. Permitindo uma maior praticidade durante a análise, bem como a criação de relatórios dos resultados. Para saber mais, acesse: [rmarkdown.rstudio.com](https://rmarkdown.rstudio.com/).

Um documento R Markdown pode ser compilado em diferentes formatos, incluindo documentos HTML , PDFs, Word, slides, entre outros, Isso permite que você foque na conteúdo, enquanto o R Markdown garante o output. 
...
Mas não fica tão bonita no documento final, visto esta base ter muitas linhas, mas existem bibliotecas específicas para tornar a tabela interativa por lá também :)  
...
Um última dica aqui é explorar a opção "Visual" do Rmarkdown (disponível em versões mais recentes), que nos permite trabalhar com uma interface mais visual, em alternativa aos códigos.
